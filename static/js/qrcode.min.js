/**
 * Standalone QRCode.js (Kazuhiko Arase / Davidshimjs)
 */
(function(root, factory) {
    ...
    CanvasDrawing.prototype.draw = function(oQRCode) {
        ...
        var width = this._htOption.width / count;
        var height = this._htOption.height / count;
        this._ctx.clearRect(0, 0, this._htOption.width, this._htOption.height);
        this._ctx.fillStyle = this._htOption.colorLight;
        this._ctx.fillRect(0, 0, this._htOption.width, this._htOption.height);
        this._ctx.fillStyle = this._htOption.colorDark;
        for (var row = 0; row < count; row++) {
            for (var col = 0; col < count; col++) {
                if (oQRCode.isDark(row, col)) {
                    this._ctx.fillRect(Math.round(col * width), Math.round(row * height), Math.ceil(width), Math.ceil(height));
                }
            }
        }
    };
